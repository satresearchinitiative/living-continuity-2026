module.exports = [
"[project]/node_modules/libmime/lib/charsets.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

/* eslint quote-props: 0*/ module.exports = {
    '866': 'IBM866',
...
"[project]/node_modules/libmime/lib/charset.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const charsets = __turbopack_context__.r("[project]/node_modules/libmime/lib/charsets.js [app-route] (ecmascript)");
/**
 ...
 */ const charset = module.exports = {
     ...
     */ normalizeCharset (charset) {
        ...
        charset = charset.replace(/^utf[-_]?(\d+)/, 'utf-$1').replace(/^(?:us[-_]?)ascii/, 'windows-1252').replace(/^win(?:dows)?[-_]?(\d+)/, 'windows-$1').replace(/^(?:latin|iso[-_]?8859)?[-_]?(\d+)/, 'iso-8859-$1').replace(/^l[-_]?(\d+)/, 'iso-8859-$1');
        // updated pass
        if (charsets.hasOwnProperty(charset) && charsets[charset]) {
            return charsets[charset];
        }
...
"[project]/node_modules/libmime/lib/mimetypes.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/libmime/lib/libmime.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

/* eslint no-control-regex: 0, no-div-regex: 0, quotes: 0 */ const { Buffer } = __turbopack_context__.r("[externals]/node:buffer [external] (node:buffer, cjs)");
const libcharset = __turbopack_context__.r("[project]/node_modules/libmime/lib/charset.js [app-route] (ecmascript)");
...
const mimetypes = __turbopack_context__.r("[project]/node_modules/libmime/lib/mimetypes.js [app-route] (ecmascript)");
...
//# sourceMappingURL=node_modules_libmime_lib_c1a1029c._.js.map