...
function RotatingImage({ imageUrl, position, scale = [
    ...
    const readButtonYPosition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        if (showTitle) {
            const topOfArticle = scale[1] / 2;
            const bottomOfArticle = -scale[1] / 2;
            const titlePosition = topOfArticle;
            const pixelsPerUnit = 20 * 2.25 * 0.9;
            const unitsPerPixel = 1 / pixelsPerUnit;
            const titleFontSizePx = 30;
            const titleLineHeightPx = titleFontSizePx * 1.35;
            const titlePaddingTopPx = 18 * 1.2;
            const titlePaddingBottomPx = 18 * 2;
            const estimatedTitleContentHeightPx = titleLineHeightPx * 2;
            const titleTotalHeightPx = titlePaddingTopPx + estimatedTitleContentHeightPx + titlePaddingBottomPx;
            const titleTotalHeight = titleTotalHeightPx * unitsPerPixel;
            const titleBottom = titlePosition - titleTotalHeight / 2;
            const availableSpace = titleBottom - bottomOfArticle;
            return bottomOfArticle + availableSpace / 2;
        }
        return 0;
    }, [
        scale,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3c319a40._.js.map