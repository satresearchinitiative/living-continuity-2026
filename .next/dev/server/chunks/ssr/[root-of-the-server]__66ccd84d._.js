...
__turbopack_context__.s([
    ...
    ()=>getCachedCrossPosition,
    "getCrossElementWorldPosition",
    ()=>getCrossElementWorldPosition,
    "registerCrossElement",
    ()=>registerCrossElement,
    "unregisterCrossElement",
    ()=>unregisterCrossElement,
...
const tempVec3 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Vector3"]();
function registerCrossElement(nodeId, element, groupRef, crossGroupRef) {
    if (element && groupRef) {
        crossElementRegistry.set(nodeId, {
            element,
            groupRef,
            crossGroupRef
        });
...
function unregisterCrossElement(nodeId) {
    crossElementRegistry.delete(nodeId);
    crossPositionCache.delete(nodeId);
}
function getCrossElementWorldPosition(nodeId, camera) {
...
function updateAllCrossPositions(camera) {
    const positions = {};
...
function RotatingImage({ imageUrl, position, scale = [
    ...
    const crossElementRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (nodeId && showCross && crossGroupRef.current && crossElementRef.current) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$utils$2f$crossPositionTracker$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["registerCrossElement"])(nodeId, crossElementRef.current, groupRef, crossGroupRef);
        } else if (nodeId) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$utils$2f$crossPositionTracker$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["unregisterCrossElement"])(nodeId);
        }
        return ()=>{
            if (nodeId) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$utils$2f$crossPositionTracker$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["unregisterCrossElement"])(nodeId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__66ccd84d._.js.map