...
function preloadAllModels(nodeData) {
    ...
    if (nodeData.articles) {
        nodeData.articles.forEach((article)=>{
            ...
            if (article.selectedModelPath && article.selectedModelPath.trim() !== '') {
                const glbPath = `/entries_selected/${article.id}.glb`;
                preloadGLBModel(glbPath);
            }
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__faa64c2b._.js.map