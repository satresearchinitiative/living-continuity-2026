...
function KitOfPartsPage() {
    ...
    const [cameraResetting, setCameraResetting] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    console.log('[DEBUG] KitOfPartsPage:', {
        captureMode,
        isCaptureModalOpen,
        wasInCapture,
        keepFramesForReset,
        frameloop: 'will be ' + (sceneRotation || captureMode || keepFramesForReset || cameraResetting ? 'always' : 'demand')
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (keepFramesForReset) {
            console.log('[DEBUG] Page: modal just closed - setting cameraResetting for 800ms');
            setCameraResetting(true);
            const t = setTimeout(()=>{
                console.log('[DEBUG] Page: cameraResetting timeout - setting false');
                setCameraResetting(false);
            }, 800);
        ...
        captureMode,
        isCaptureModalOpen
    ]); // deps for when we detect close; keepFramesForReset would flip to false next render and clear timeout
    const handleButton = ()=>{
    ...
    /** Forces camera to axonometric when modal closes - runs in useFrame to overwrite OrbitControls */ const CameraResetOnExitCapture = /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].memo(()=>{
        const { camera } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$f8cd670d$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__C__as__useThree$3e$__["useThree"])();
        const [captureMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useStore"])("kitOfParts_captureMode", false);
        const resetFramesRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(0);
        const prevCaptureModeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(captureMode);
        const frameCountRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$f8cd670d$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__D__as__useFrame$3e$__["useFrame"])((state, delta)=>{
            ...
            if (frameCountRef.current % 60 === 0) {
                console.log('[DEBUG] CameraResetOnExitCapture useFrame:', {
                    captureMode,
                    wasCapture,
                    resetFramesLeft: resetFramesRef.current
                });
            }
            // Just exited capture mode - force camera for several frames (overwrites OrbitControls)
            if (wasCapture && !captureMode) {
                resetFramesRef.current = 15;
                console.log('[DEBUG] CameraResetOnExitCapture: DETECTED EXIT - will force camera for 15 frames');
            }
            if (resetFramesRef.current > 0) {
                ...
                camera.lookAt(0, 0, 0);
                camera.updateProjectionMatrix();
                if (resetFramesRef.current === 14) {
                    console.log('[DEBUG] CameraResetOnExitCapture: APPLIED axonometric view');
                }
            }
        });
        return null;
    });
    CameraResetOnExitCapture.displayName = 'CameraResetOnExitCapture';
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
            if (state.camera && state.camera.isOrthographicCamera) {
                ...
                if (captureMode === true) {
                    ...
                    // CameraResetOnExitCapture handles the switch in useFrame (runs after OrbitControls)
                    console.log('[DEBUG] CameraDolly: justExitedCaptureMode, deferring to CameraResetOnExitCapture');
                    prevCaptureModeRef.current = captureMode;
                    isInitialMountRef.current = false;
                    return;
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Suspense"], {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(CameraResetOnExitCapture, {}, void 0, false, {
                                fileName: "[project]/app/kit-of-parts/page.js",
                                lineNumber: 504,
                                columnNumber: 13
                            }, this),
...
//# sourceMappingURL=_a169b552._.js.map