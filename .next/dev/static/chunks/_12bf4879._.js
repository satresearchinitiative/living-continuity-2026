...
;
;
var crossElementRegistry = new Map();
...
var tempVec3 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector3"]();
...
function getCrossElementWorldPosition(nodeId, camera) {
    var entry = crossElementRegistry.get(nodeId);
    if (!entry || !entry.crossGroupRef || !entry.crossGroupRef.current) return null;
    try {
        var crossGroup = entry.crossGroupRef.current;
        ...
        console.warn("[crossPositionTracker] Error getting position for ".concat(nodeId, ":"), error);
        return null;
    }
}
function updateAllCrossPositions(camera) {
    var positions = {};
    crossElementRegistry.forEach(function(entry, nodeId) {
        var pos = getCrossElementWorldPosition(nodeId, camera);
        if (pos) {
...
function RotatingImage(param) {
    ...
    var crossElementRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
            ...
            var performMeasurement = {
                "RotatingImage.useEffect.performMeasurement": function() {
                    ...
                    if (measuredHeight !== null && measuredHeight > 0) {
                        ...
                        }["RotatingImage.useEffect.performMeasurement"], 100);
                        return true;
                    }
                    return false;
                }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RotatingImage.useEffect": function() {
            if (nodeId && showCross && crossGroupRef.current && crossElementRef.current) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$utils$2f$crossPositionTracker$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["registerCrossElement"])(nodeId, crossElementRef.current, groupRef, crossGroupRef);
            } else if (nodeId) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$utils$2f$crossPositionTracker$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["unregisterCrossElement"])(nodeId);
            }
            return ({
                "RotatingImage.useEffect": function() {
                    if (nodeId) {
...
_s(RotatingImage, "c5wNAZnJ5i0xcxEeceqQaw/RZn8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$f8cd670d$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__D__as__useFrame$3e$__["useFrame"]
    ];
});
...
//# sourceMappingURL=_12bf4879._.js.map