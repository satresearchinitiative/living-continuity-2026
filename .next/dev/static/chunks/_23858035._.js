...
__turbopack_context__.s([
    ...
    ()=>kitOfPartsBoxbedStateStore,
    "kitOfPartsCachedImageDataUrlStore",
    ()=>kitOfPartsCachedImageDataUrlStore,
    "kitOfPartsCameraStateStore",
    ()=>kitOfPartsCameraStateStore,
    "kitOfPartsCaptureModalOpenStore",
    ()=>kitOfPartsCaptureModalOpenStore,
    "kitOfPartsCaptureModeStore",
    ()=>kitOfPartsCaptureModeStore,
    "kitOfPartsClickbathroom2Store",
    ()=>kitOfPartsClickbathroom2Store,
    "kitOfPartsCloseAllPanelsStore",
    ()=>kitOfPartsCloseAllPanelsStore,
...
var kitOfPartsCaptureModeStore = createStoreSafe('kitOfParts_captureMode', false);
var kitOfPartsCaptureModalOpenStore = createStoreSafe('kitOfParts_captureModalOpen', false);
var kitOfPartsCachedImageDataUrlStore = createStoreSafe('kitOfParts_cachedImageDataUrl', null);
var kitOfPartsCloseAllPanelsStore = createStoreSafe('kitOfParts_closeAllPanels', false);
...
"[project]/components/utils/perfDebugHooks.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var consoleApiRegistered = false;
...
function printPerfDebugHelp() {
    var h = 'line-height:1.45;font-size:12px;';
    var box = 'background:#0d1117;color:#c9d1d9;padding:10px 12px;border-left:4px solid #238636;font-family:ui-monospace,monospace;';
    var cmd = 'color:#79c0ff;font-weight:bold;';
    console.log('%c[perf] Violations: what / why / how to trace', 'background:#1f6feb;color:#fff;padding:4px 8px;font-size:13px;font-weight:bold;');
    console.log('%cChrome [Violation] = the browser saying a rAF, setTimeout, click, or React scheduler task took too long. The app does not emit those lines; you cannot remove them without faster code or muting the console (DevTools → Console → settings → turn off violation messages, wording varies).', h + box);
    console.log('%cTo see which code scheduled a slow rAF or setTimeout: run %cenablePerfDebug()%c in this console, press Enter, reload. Then open the groups labeled [perf-debug] SLOW … — the stack is “scheduled from” (source).', h + box, cmd, h + box);
    console.log('%cGlossary heavy work: the scroll handler measures many list items (layout). Run %cenableGlossaryPerfDebug()%c, reload, for timings. Click handlers are not wrapped — use React Profiler for “[Violation] click”.', h + box, cmd, h + box);
    console.log('%cGlossary scroll “jumping”: this project sets glossary html/body to scroll-behavior: auto, programmatic scroll to behavior: auto, and skips URL hash replace while data-restoring-scroll is on — so restore should not smooth-scroll or fight the hash.', h + box);
...
function registerPerfDebugConsole() {
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
    ...
    window.enableGlossaryPerfDebug = function() {
        try {
    ...
    try {
        if (!sessionStorage.getItem('__perf_debug_full_help_once')) {
            ...
            console.log('%c[perf]', 'background:#238636;color:#fff;padding:3px 8px;font-weight:bold', 'Hooks off until you run enablePerfDebug() + reload. printPerfDebugHelp() for full story.');
        }
    } catch (e) {
        printPerfDebugHelp();
    }
}
function initPerfDebugHooks() {
    if (("TURBOPACK compile-time value", "object") === 'undefined' || hooksInstalled) return;
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
    ...
    var origSt = w.setTimeout.bind(w);
    var rafLogCount = 0;
    var stLogCount = 0;
    var logCap = 80;
    console.info('%c[perf-debug] Hooks ACTIVE', 'background:#238636;color:#fff;padding:2px 6px', 'rAF >', RAF_MS, 'ms · setTimeout fn >', TIMEOUT_MS, 'ms · logs capped at', logCap);
    w.requestAnimationFrame = function requestAnimationFramePatched(cb) {
        if (typeof cb !== 'function') {
            return origRaf(cb);
        }
        var scheduleStack = new Error('[perf-debug] rAF schedule trace').stack;
        return origRaf(function(time) {
            ...
            try {
                ...
                if (ms > RAF_MS && rafLogCount < logCap) {
                    rafLogCount += 1;
                    console.groupCollapsed("%c[perf-debug] SLOW rAF %c".concat(ms.toFixed(1), "ms"), 'color:#f85149;font-weight:bold', 'color:#ffb657');
            ...
            var po = new PerformanceObserver(function(list) {
                ...
                try {
                    for(var _iterator = list.getEntries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                        ...
                        console.warn('%c[perf-debug] longtask', 'color:#db61a2;font-weight:bold', {
                            durationMs: e.duration.toFixed(0),
                            name: e.name
                        });
                    }
                } catch (err) {
    ...
    w.setTimeout = function setTimeoutPatched(fn, delay) {
        for(var _len = arguments.length, args = new Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++){
            args[_key - 2] = arguments[_key];
        }
        if (typeof fn !== 'function') {
            return origSt.apply(void 0, [
                fn,
                delay
        ...
        var scheduleStack = new Error('[perf-debug] setTimeout schedule trace').stack;
        return origSt.apply(void 0, [
            function setTimeoutPatchedRun() {
                ...
                try {
                    ...
                    if (ms > TIMEOUT_MS && stLogCount < logCap) {
                        stLogCount += 1;
                        console.groupCollapsed("%c[perf-debug] SLOW setTimeout %c".concat(ms.toFixed(1), "ms %c(delay=").concat(delay, ")"), 'color:#f85149;font-weight:bold', 'color:#ffb657', 'color:#8b949e');
                        console.log('Scheduled from:\n', scheduleStack);
                        console.groupEnd();
                    }
                }
...
function Menu(param) {
    ...
    var menuItems = [
        ...
        {
            label: 'Toolkit',
            href: 'https://drive.google.com/drive/u/2/folders/12uXdvFvDyFfQSQ1xgGVDB3wzs5fKsMnV',
            external: true
        }
    ];
...
_s(HomeTitle, "wAGa5I9YzBivRMmH5m/kM59m73o=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"]
    ];
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "info-panel-content-inner",
                                    children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        authorBio && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    dangerouslySetInnerHTML: {
                                        __html: function() {
                                            var processed = authorBio;
                                            if (author) {
                                                var escaped = author.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
                                                processed = processed.replace(new RegExp("(?<!\\*\\*)(".concat(escaped, ")(?!\\*\\*)"), 'g'), '**$1**');
                                            }
                                            return processed.replace(/\*\*(.*?)\*\*/g, '<strong>$1</strong>').replace(/\*(.*?)\*/g, '<em>$1</em>').replace(/\n/g, '<br/>');
                                        }()
                                    }
                                }, void 0, false, {
                                    fileName: "[project]/components/treeModals/archiveModal.jsx",
                        ...
                        function() {
                            ...
                            var getKeywordText = function(keyword) {
                                return keyword && (typeof keyword === "undefined" ? "undefined" : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_type_of$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(keyword)) === 'object' ? keyword.text || keyword : keyword;
                            };
                            var sortedKeywordsToDisplay = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_to_consumable_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(keywordsToDisplay).sort(function(a, b) {
                                return String(getKeywordText(a) || '').localeCompare(String(getKeywordText(b) || ''), undefined, {
                                    sensitivity: 'base'
                                });
                            });
                            var connectionsToDisplay = [
                                connect1,
                                connect2,
                                connect3,
                                connect4
                            ...
                            var hasKeywordsToShow = sortedKeywordsToDisplay.length > 0;
                            ...
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    hasKeywordsToShow ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: sortedKeywordsToDisplay.map(function(keyword, index) {
                                            var keywordText = getKeywordText(keyword);
                                            ...
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                children: [
                                                    keywordLink ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                        ...
                                                        className: "item_link",
                                                        onClick: function(e) {
                                                            if (keywordLink && keywordLink.startsWith("/glossary#") && pathname === "/glossary") {
                                                                e.preventDefault();
                                                                var hashPart = keywordLink.split("#").slice(1).join("#");
                                                                if (typeof closeModal === "function") {
                                                                    closeModal({
                                                                        fromGlossaryKeywordLink: true
                                                                    });
                                                                }
                                                                if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
                                                                ;
                                                    ...
                                                    index < sortedKeywordsToDisplay.length - 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "comma",
                                                        children: ", "
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/treeModals/archiveModal.jsx",
                                        ...
                                        lineNumber: 142,
                                        columnNumber: 19
                                    }, _this) : connectionsToDisplay.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "connections",
                                        children: connectionsToDisplay.map(function(item, index, array) {
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "item",
...
_s(ArchiveModal, "P7gnV09xuuRSjE8u1kRqNOeqUxY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"]
    ];
...
"[project]/components/navigation/IndexPanel.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function IndexPanel(param) {
    var _this = this;
    var isOpen = param.isOpen, onClose = param.onClose, onReopen = param.onReopen;
    var _selectedArticle_connectionKeywords, _selectedArticle_connectionKeywords1, _selectedArticle_connectionKeywords2, _selectedArticle_connectionKeywords3;
    _s();
    var _React_useState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState([]), 2), articles = _React_useState[0], setArticles = _React_useState[1];
    var _React_useState1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState(true), 2), loading = _React_useState1[0], setLoading = _React_useState1[1];
    var _React_useState2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState(null), 2), selectedArticle = _React_useState2[0], setSelectedArticle = _React_useState2[1];
    var _React_useState3 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState(false), 2), modalIsOpen = _React_useState3[0], setModalIsOpen = _React_useState3[1];
    var _React_useState4 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState(false), 2), openedFromIndex = _React_useState4[0], setOpenedFromIndex = _React_useState4[1];
    var pendingArticleRef = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useRef(null);
    var listRef = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useRef(null);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "IndexPanel.useEffect": function() {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "IndexPanel.useEffect": function() {
            if (!isOpen) return;
            var checkForModal = {
                "IndexPanel.useEffect.checkForModal": function() {
                    var hasArchiveModalOpen = document.body.classList.contains('archive-modal-open');
                    if (hasArchiveModalOpen && !modalIsOpen) {
                        onClose();
                    }
                }
            }["IndexPanel.useEffect.checkForModal"];
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "IndexPanel.useEffect": function() {
            if (!isOpen && pendingArticleRef.current) {
                var article = pendingArticleRef.current;
                ...
                setTimeout({
                    "IndexPanel.useEffect": function() {
                        ...
                        if (article.id) {
                            window.history.pushState(null, '', "#".concat(article.id));
                        }
                    }
                }["IndexPanel.useEffect"], 300);
            }
        }
    }["IndexPanel.useEffect"], [
        isOpen
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "IndexPanel.useEffect": function() {
            var loadArticles = {
                "IndexPanel.useEffect.loadArticles": function() {
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_async_to_generator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])({
                        "IndexPanel.useEffect.loadArticles": function() {
                            var response, data, sortedArticles, hash, articleFromHash, error;
                            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, {
                                "IndexPanel.useEffect.loadArticles": function(_state) {
                                    switch(_state.label){
                                        case 0:
                                            _state.trys.push([
                                                0,
                                            ...
                                            return [
                                                4,
                                                fetch("/data/nodes.json?t=".concat(Date.now()))
                                            ];
                                        case 1:
                                            response = _state.sent();
                                            if (!response.ok) {
                                                throw new Error("HTTP ".concat(response.status, ": Failed to load articles"));
                                            }
                                            return [
                                                4,
                                                response.json()
                                        ...
                                        case 2:
                                            data = _state.sent();
                                            sortedArticles = (data.articles || []).sort({
                                                "IndexPanel.useEffect.loadArticles": function(a, b) {
                                                    var titleA = (a.title || '').toLowerCase();
                                                    var titleB = (b.title || '').toLowerCase();
                                                    return titleA.localeCompare(titleB);
                                                }
                                            }["IndexPanel.useEffect.loadArticles"]);
                                            setArticles(sortedArticles);
                                            hash = window.location.hash.substring(1);
                                            if (hash && !modalIsOpen && !selectedArticle) {
                                                articleFromHash = sortedArticles.find({
                                                    "IndexPanel.useEffect.loadArticles": function(a) {
                                                        return a.id === hash;
                                                    }
                                                }["IndexPanel.useEffect.loadArticles"]);
                                                if (articleFromHash) {
                                                    ...
                                                    }["IndexPanel.useEffect.loadArticles"], 500);
                                                }
                                            }
                                            return [
                                                3,
    ...
    var handleCloseModal = function() {
        var wasOpenedFromIndex = openedFromIndex;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "index-panel-wrapper ".concat(isOpen ? 'open' : ''),
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "index-panel-close",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$menu$2f$CrossButton$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            color: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$_setup$2f$colors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COLOR_BLACK"],
                            onClick: handlePanelClose
                        }, void 0, false, {
                            fileName: "[project]/components/navigation/IndexPanel.jsx",
                            lineNumber: 164,
                            columnNumber: 11
                        }, this)
                    }, void 0, false, {
                                    ...
                                    children: articles.map(function(article) {
                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            children: [
                                                ...
                                                article.title,
                                                article.author && " — ".concat(article.author)
                                            ]
                                        }, article.id, true, {
                                            fileName: "[project]/components/navigation/IndexPanel.jsx",
                                            lineNumber: 178,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "index-panel-overlay ".concat(isOpen && !modalIsOpen ? 'open' : ''),
                onClick: handlePanelClose
            }, void 0, false, {
                fileName: "[project]/components/navigation/IndexPanel.jsx",
                lineNumber: 192,
            ...
            selectedArticle && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$modal$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$treeModals$2f$archiveModal$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    ...
                    connect1: ((_selectedArticle_connectionKeywords = selectedArticle.connectionKeywords) === null || _selectedArticle_connectionKeywords === void 0 ? void 0 : _selectedArticle_connectionKeywords[0]) || "",
                    connect2: ((_selectedArticle_connectionKeywords1 = selectedArticle.connectionKeywords) === null || _selectedArticle_connectionKeywords1 === void 0 ? void 0 : _selectedArticle_connectionKeywords1[1]) || "",
                    connect3: ((_selectedArticle_connectionKeywords2 = selectedArticle.connectionKeywords) === null || _selectedArticle_connectionKeywords2 === void 0 ? void 0 : _selectedArticle_connectionKeywords2[2]) || "",
                    connect4: ((_selectedArticle_connectionKeywords3 = selectedArticle.connectionKeywords) === null || _selectedArticle_connectionKeywords3 === void 0 ? void 0 : _selectedArticle_connectionKeywords3[3]) || "",
...
_s(IndexPanel, "e91adNtvNIc60/G9zs6xN/NBb0U=");
_c = IndexPanel;
var _c;
__turbopack_context__.k.register(_c, "IndexPanel");
if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_type_of$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(globalThis.$RefreshHelpers$) === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/utils/recaptcha.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function loadRecaptchaScript(siteKey) {
    ...
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
    if ((_window_grecaptcha = window.grecaptcha) === null || _window_grecaptcha === void 0 ? void 0 : _window_grecaptcha.ready) return Promise.resolve();
    if (scriptLoadPromise) return scriptLoadPromise;
    scriptLoadPromise = new Promise(function(resolve, reject) {
        var script = document.createElement('script');
        script.src = "".concat(RECAPTCHA_SCRIPT_URL, "?render=").concat(siteKey);
        script.async = true;
        script.onload = function() {
            return resolve();
        };
        script.onerror = function() {
            return reject(new Error('reCAPTCHA script failed to load'));
        };
...
function getRecaptchaToken(siteKey) {
    var action = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 'submit';
...
"[project]/components/utils/formSubmissionClient.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "isFormSubmissionClientDebug",
    ()=>isFormSubmissionClientDebug,
    "logFormSubmissionFailure",
    ()=>logFormSubmissionFailure,
...
;
;
function isFormSubmissionClientDebug() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_FORM_SUBMISSION_DEBUG === 'true';
}
function logFormSubmissionFailure(endpoint, status, body) {
    console.error("[Form:".concat(endpoint, "]"), {
        status: status,
        code: body === null || body === void 0 ? void 0 : body.code,
        error: body === null || body === void 0 ? void 0 : body.error,
        details: body === null || body === void 0 ? void 0 : body.details,
        debug: body === null || body === void 0 ? void 0 : body.debug
    });
}
function userFacingFormError(body, defaultMsg) {
    if (!body || (typeof body === "undefined" ? "undefined" : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_type_of$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(body)) !== 'object') return defaultMsg;
    var parts = [
...
function parseFormErrorResponse(response, endpointLabel) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_async_to_generator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(function() {
        var body;
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, function(_state) {
            switch(_state.label){
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$menu$2f$CrossButton$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/menu/CrossButton.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$_setup$2f$colors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/_setup/colors.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$utils$2f$recaptcha$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/utils/recaptcha.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$utils$2f$formSubmissionClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/utils/formSubmissionClient.js [app-client] (ecmascript)");
;
;
;
;
...
function SubmitEntryPanel(param) {
    ...
    var _useState2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(''), 2), website = _useState2[0], setWebsite = _useState2[1];
    ...
    var handleSubmit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SubmitEntryPanel.useCallback[handleSubmit]": function() {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_async_to_generator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])({
                "SubmitEntryPanel.useCallback[handleSubmit]": function() {
                    var siteKey, token, _tmp, formData, response, errorBody, error;
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, {
                        "SubmitEntryPanel.useCallback[handleSubmit]": function(_state) {
                            switch(_state.label){
                                ...
                                case 1:
                                    ...
                                    return [
                                        4,
                                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$utils$2f$recaptcha$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRecaptchaToken"])(siteKey, 'glossary_submit')
                                    ];
                                case 2:
                                    _tmp = _state.sent();
                                    return [
                                ...
                                case 6:
                                    return [
                                        4,
                                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$utils$2f$formSubmissionClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseFormErrorResponse"])(response, 'submit-entry')
                                    ];
                                case 7:
                                    errorBody = _state.sent();
                                    setSubmitError((0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$utils$2f$formSubmissionClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userFacingFormError"])(errorBody, 'Submission failed.'));
                                    _state.label = 8;
                                case 8:
                                    return [
                                        3,
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: "By submitting an entry, you consent to its use for research, educational, and documentation purposes related to this project. Identifying information will not be shared without your consent."
                                        }, void 0, false, {
                                            fileName: "[project]/components/navigation/SubmitEntryPanel.jsx",
                                            lineNumber: 249,
                                            columnNumber: 15
                                ...
                                submitError ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "submit-entry-submit-error",
                                    role: "alert",
...
_s(SubmitEntryPanel, "WCQVywVR4pmqZyWmhTzP5DFGTlo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"]
    ];
});
...
"[project]/components/captureModal/CaptureModal.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function CaptureModal(param) {
    var isOpen = param.isOpen, onClose = param.onClose, cachedImageDataUrl = param.cachedImageDataUrl;
    _s();
    var _useState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false), 2), isSubmitting = _useState[0], setIsSubmitting = _useState[1];
    var _useState1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(''), 2), submitError = _useState1[0], setSubmitError = _useState1[1];
    var _useState2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(''), 2), website = _useState2[0], setWebsite = _useState2[1];
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "CaptureModal.useEffect": function() {
            if (isOpen) {
                document.body.classList.add('menu-open');
            } else {
                document.body.classList.remove('menu-open');
    ...
    var downloadImage = function(dataUrl) {
        ...
        link.download = "floor-plan-".concat(Date.now(), ".png");
        link.href = dataUrl;
        link.click();
    };
    var handleSubmit = function() {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_async_to_generator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(function() {
            var siteKey, token, _tmp, response, blob, formData, submitResponse, err, error;
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, function(_state) {
                switch(_state.label){
                    case 0:
                    ...
                    case 1:
                        ...
                        return [
                            4,
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$utils$2f$recaptcha$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRecaptchaToken"])(siteKey, 'screenshot_submit')
                        ];
                    case 2:
                        _tmp = _state.sent();
                        return [
                    ...
                    case 6:
                        ...
                        return [
                            4,
                            fetch('/api/submit-floor-plan', {
                                method: 'POST',
                                body: formData
                            })
                        ];
                    case 7:
                        submitResponse = _state.sent();
                        ...
                        return [
                            4,
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$utils$2f$formSubmissionClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseFormErrorResponse"])(submitResponse, 'submit-floor-plan')
                        ];
                    case 8:
                        err = _state.sent();
                        setSubmitError((0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$utils$2f$formSubmissionClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userFacingFormError"])(err, 'Could not send your floor plan.'));
                        setIsSubmitting(false);
                        return [
                            2
                        ];
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "capture-modal-wrapper ".concat(isOpen ? 'open' : ''),
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$menu$2f$CrossButton$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    ...
                    fileName: "[project]/components/captureModal/CaptureModal.jsx",
                    lineNumber: 93,
                    columnNumber: 9
                }, this)
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "capture-modal-content",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                        type: "text",
                        name: "website",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "capture-modal-text",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            children: "If you want to share your floor Plan arrangement with us Click submit Below"
                        }, void 0, false, {
                            fileName: "[project]/components/captureModal/CaptureModal.jsx",
                            lineNumber: 108,
                            columnNumber: 11
                    ...
                    submitError ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "capture-modal-submit-error",
                        role: "alert",
                        children: submitError
                    }, void 0, false, {
                        fileName: "[project]/components/captureModal/CaptureModal.jsx",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: isSubmitting ? 'Submitting...' : !cachedImageDataUrl ? 'Loading data...' : 'submit'
                    }, void 0, false, {
                        fileName: "[project]/components/captureModal/CaptureModal.jsx",
                        lineNumber: 117,
                        columnNumber: 9
...
_s(CaptureModal, "CNUTvqIf/tPTWDNRDhAR6xQplQ0=");
_c = CaptureModal;
var _c;
__turbopack_context__.k.register(_c, "CaptureModal");
if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_type_of$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(globalThis.$RefreshHelpers$) === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$navigation$2f$IndexPanel$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/navigation/IndexPanel.jsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$captureModal$2f$CaptureModal$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/captureModal/CaptureModal.jsx [app-client] (ecmascript)");
;
;
;
var _s = __turbopack_context__.k.signature();
...
function NavigationControls(param) {
    ...
    var _useStore16 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])('kitOfParts_closeAllPanels', false), 2), closeAllPanels = _useStore16[0], setCloseAllPanels = _useStore16[1];
    var _useStore17 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])('kitOfParts_captureModalOpen', false), 2), isCaptureModalOpen = _useStore17[0], setIsCaptureModalOpen = _useStore17[1];
    var _useStore18 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])('kitOfParts_cachedImageDataUrl', null), 1), cachedImageDataUrl = _useStore18[0];
    var _useStore19 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])('kitOfParts_captureMode', false), 2), setCaptureMode = _useStore19[1];
    var _useStore20 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])('kitOfParts_cachedImageDataUrl', null), 2), setCachedImageDataUrl = _useStore20[1];
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NavigationControls.useEffect": function() {
    ...
    var handleCloseCaptureModal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NavigationControls.useCallback[handleCloseCaptureModal]": function() {
            setIsCaptureModalOpen(false);
            setCaptureMode(false);
            setTimeout({
                "NavigationControls.useCallback[handleCloseCaptureModal]": function() {
                    return setCachedImageDataUrl(null);
                }
            }["NavigationControls.useCallback[handleCloseCaptureModal]"], 300);
        }
    }["NavigationControls.useCallback[handleCloseCaptureModal]"], [
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    isGlossaryPage ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                children: walkThroughActive ? 'static view' : ' dynamic view'
                            }, void 0, false, {
                                fileName: "[project]/components/navigation/NavigationControls.jsx",
                                lineNumber: 548,
                                columnNumber: 13
                    ...
                    isKitOfPartsPage && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$captureModal$2f$CaptureModal$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(NavigationControls, "FLR+ZfZaza5dLuU1Ej+uXIKNA1Q=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$utils$2f$perfDebugHooks$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/utils/perfDebugHooks.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/client/app-dir/link.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$modal$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-modal/lib/index.js [app-client] (ecmascript)");
...
;
if ("TURBOPACK compile-time truthy", 1) {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$utils$2f$perfDebugHooks$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["registerPerfDebugConsole"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$utils$2f$perfDebugHooks$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initPerfDebugHooks"])();
}
;
;
;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RootLayout.useEffect": function() {
            ...
            var timeoutId = window.setTimeout({
                "RootLayout.useEffect.timeoutId": function() {
                        ...
                        "RootLayout.useEffect.timeoutId": function() {
                            rafId2 = requestAnimationFrame({
                                "RootLayout.useEffect.timeoutId": function() {
                                    ...
                                    }["RootLayout.useEffect.timeoutId"]);
                                }
                            }["RootLayout.useEffect.timeoutId"]);
                        }
                    }["RootLayout.useEffect.timeoutId"]);
                }
            }["RootLayout.useEffect.timeoutId"], 350);
            return ({
                "RootLayout.useEffect": function() {
...
//# sourceMappingURL=_23858035._.js.map