...
function GlossaryList() {
    ...
    var articleImagesStackRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    var isCalculatingScaleRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    var scaleCalculationTimeoutRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    var lastCalculatedMaxHeightRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    var _useState3 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({}), 2), wrapperMaxHeights = _useState3[0], setWrapperMaxHeights = _useState3[1];
    var _useState4 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({}), 2), wrapperMaxWidths = _useState4[0], setWrapperMaxWidths = _useState4[1];
    var _useState5 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({}), 2), wrapperMinWidths = _useState5[0], setWrapperMinWidths = _useState5[1];
    ...
    var parseGlossaryHash = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "GlossaryList.useCallback[parseGlossaryHash]": function(hash) {
            if (!hash) return {
                keywordSlug: null,
                articleId: null
            };
            if (hash.includes(':')) {
                ...
                var keywordSlug = hash.slice(0, idx).trim() || null;
                var articleId = hash.slice(idx + 1).trim() || null;
                return {
                    keywordSlug: keywordSlug || null,
                    articleId: articleId || null
                };
            }
            var parts = hash.split('-');
            var last = parts[parts.length - 1];
            var isArticleId = allArticles.some({
                "GlossaryList.useCallback[parseGlossaryHash].isArticleId": function(a) {
                    return a.id === last;
                }
            }["GlossaryList.useCallback[parseGlossaryHash].isArticleId"]);
            if (isArticleId && parts.length >= 2) {
                return {
                    keywordSlug: parts.slice(0, -1).join('-'),
                    articleId: last
                };
            }
            return {
    ...
    }["GlossaryList.useCallback[parseGlossaryHash]"], [
        allArticles
    ]);
        ...
        "GlossaryList.useCallback[updateCenteredKeyword]": function(keywordId) {
            ...
            if (("TURBOPACK compile-time value", "object") !== 'undefined' && keywordId && glossaryData.length > 0) {
                ...
                if (keyword) {
                    ...
                    var _parseGlossaryHash = parseGlossaryHash(currentHash), hashArticleId = _parseGlossaryHash.articleId;
                    var hasArticleInHash = !!hashArticleId;
                    var isArticleHash = allArticles.some({
                        "GlossaryList.useCallback[updateCenteredKeyword].isArticleHash": function(article) {
    ...
    var _useState9 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        ...
        'G30',
        'G17'
    ]), 2), keywordsWithArticles = _useState9[0], setKeywordsWithArticles = _useState9[1];
    ...
    var scrollPositionBeforeModalRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    var isClosingModalRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    ...
    var handleHashNavigation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "GlossaryList.useCallback[handleHashNavigation]": function(hash) {
            ...
            if (keywordSlug.endsWith('-submit')) {
                ...
                var keyword = getKeywordBySlug(keywordSlugClean);
                if (keyword) {
                    var attemptScroll = {
            ...
            var keyword1 = getKeywordBySlug(keywordSlug);
            if (keyword1) {
                var attemptScroll1 = {
                    "GlossaryList.useCallback[handleHashNavigation].attemptScroll": function() {
                        var attempt = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GlossaryList.useEffect": function() {
            Promise.all([
                ...
                fetch('/data/glossary-connections.json').then({
                    "GlossaryList.useEffect": function(res) {
                        return res.json();
                    }
                ...
                "GlossaryList.useEffect": function(param) {
                    var _param = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(param, 3), glossaryData = _param[0], nodesData = _param[1], connectionsData = _param[2];
                    // Set articles
                    ...
                    if (glossaryData && glossaryData.glossary) {
                        var connectionsMap = connectionsData.glossary || {};
    ...
    var calculateWrapperHeights = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "GlossaryList.useCallback[calculateWrapperHeights]": function() {
            if (("TURBOPACK compile-time value", "object") === 'undefined' || relatedArticles.length === 0) {
            ...
            var isMobile = window.innerWidth <= 812;
            if (isMobile) {
                var paddingBaseValue = 18;
                var paddingBaseWidth = 834;
                var padding = window.innerWidth * paddingBaseValue / paddingBaseWidth;
                var availableWidth = window.innerWidth - padding * 2;
                var numberOfWrappers = relatedArticles.length;
                var naturalWidthPerWrapper = availableWidth / 6;
                var totalNaturalWidth = naturalWidthPerWrapper * numberOfWrappers;
                var maxAllowedWidth = window.innerWidth - padding * 2;
                if (numberOfWrappers > 5 && totalNaturalWidth > maxAllowedWidth && maxAllowedWidth > 0) {
                    var reductionFactor = 0.7;
                    var condensedWidthPerWrapper = maxAllowedWidth / numberOfWrappers * reductionFactor;
                    var minWidth = 50;
                    var finalWidth = Math.max(condensedWidthPerWrapper, minWidth);
                    var maxWidths = {};
                    var minWidths = {};
                    relatedArticles.forEach({
                        "GlossaryList.useCallback[calculateWrapperHeights]": function(article) {
                            maxWidths[article.id] = finalWidth;
                            minWidths[article.id] = minWidth;
                        }
                    }["GlossaryList.useCallback[calculateWrapperHeights]"]);
            ...
            var headerHeight = Math.min(window.innerHeight * 0.075, 96);
            var titleHeight = Math.min(window.innerHeight * 0.12, 160);
            var footerHeight = 0;
            var extraPadding = Math.min(window.innerHeight * 0.03, 48);
            var maxAllowedHeight = window.innerHeight - headerHeight - titleHeight - footerHeight - extraPadding;
            var minStackHeight = 80;
            var maxStackHeight = 240;
            var vwHeight = window.innerWidth * 0.12;
            var vhHeight = window.innerHeight * 0.12;
            var imageStackHeightValue = Math.max(minStackHeight, Math.min(Math.min(vwHeight, vhHeight), maxStackHeight));
            var naturalHeightPerWrapper = imageStackHeightValue;
            var numberOfWrappers1 = relatedArticles.length;
            var totalNaturalHeight = naturalHeightPerWrapper * numberOfWrappers1;
            if (numberOfWrappers1 > 4 && totalNaturalHeight > maxAllowedHeight && maxAllowedHeight > 0) {
                var scaleFactor = maxAllowedHeight / totalNaturalHeight;
                var reductionFactor1 = 0.95;
                var condensedHeight = naturalHeightPerWrapper * scaleFactor * reductionFactor1;
                var heights = {};
                relatedArticles.forEach({
                    "GlossaryList.useCallback[calculateWrapperHeights]": function(article) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GlossaryList.useEffect": function() {
            ...
            var stack = articleImagesStackRef.current;
            var hasCondensedHeights = Object.keys(wrapperMaxHeights).length > 0;
            var hasCondensedWidths = Object.keys(wrapperMaxWidths).length > 0;
            var isMobile = window.innerWidth <= 812;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GlossaryList.useEffect": function() {
            var handleResize = {
                "GlossaryList.useEffect.handleResize": function() {
                    calculateWrapperHeights();
                }
            }["GlossaryList.useEffect.handleResize"];
    ...
    var handleArticleClick = function(article) {
        ...
        var currentKeywordId = centeredKeywordIdRef.current || centeredKeywordId;
        if (currentKeywordId && glossaryData.length > 0) {
            var keyword = glossaryData.find(function(k) {
                return k.id === currentKeywordId;
            });
            if (keyword) {
        ...
        if (!keywordHashBeforeModalRef.current) {
            ...
            var currentKeyword = getKeywordBySlug(parsedSlug || currentHash);
            if (currentKeyword) {
        ...
        if (isMobile && listRef.current) {
            listRef.current.addEventListener('scroll', preventScroll, {
                passive: false,
                capture: true
            });
        } else {
    ...
    var articleImagesStackContent = relatedArticles.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: relatedArticles.map(function(article) {
            ...
            var isMobile = ("TURBOPACK compile-time value", "object") !== 'undefined' && window.innerWidth <= 812;
            var maxHeight = !isMobile && wrapperMaxHeights[article.id] ? "".concat(wrapperMaxHeights[article.id], "px") : undefined;
            var maxWidth = isMobile && wrapperMaxWidths[article.id] ? "".concat(wrapperMaxWidths[article.id], "px") : undefined;
            var minWidth = isMobile && wrapperMinWidths[article.id] ? "".concat(wrapperMinWidths[article.id], "px") : undefined;
            var style = {};
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                ...
                children: allKeywordsInOrder.map(function(keyword) {
...
//# sourceMappingURL=_2b166dc6._.js.map