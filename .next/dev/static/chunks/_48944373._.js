...
function ConnectionController(param) {
    ...
    var getCrossPosition = function(nodeId, nodePosition) {
        var cacheKey = "".concat(nodeId, "-").concat(nodePosition[0], "-").concat(nodePosition[1], "-").concat(nodePosition[2]);
        ...
        var directionToCenter = tempDirToCenter.current.subVectors(center, nodeVec).normalize();
        var worldUp = worldUpCross.current;
        var right = tempRight.current.crossVectors(worldUp, directionToCenter);
        if (right.length() < 0.001) {
            right.set(1, 0, 0);
        }
        right.normalize();
        var up = tempUp.current.crossVectors(directionToCenter, right).normalize();
    ...
    var lines = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ConnectionController.useMemo[lines]": function() {
            ...
            var startPosition = getCrossPosition(selectedNode.id, nodePosition);
            ...
            if (targetsLength > 0) {
                for(var i = 0; i < targetsLength; i++){
                    ...
                    var endPosition = getCrossPosition(targetId, targetNodePosition);
            ...
            if (isArticle) {
                ...
                for(var i2 = 0; i2 < relatedArticles.length; i2++){
                    ...
                    for(var j = 0; j < sharedKeywords.length; j++){
                        ...
                        var relatedArticleStartPos = getCrossPosition(relatedArticleId, relatedArticlePos);
                        var keywordEndPos = getCrossPosition(sharedKeywordId, keywordPos);
                        var line1 = createLine(relatedArticleStartPos, keywordEndPos, targetsLength + whiteLineIndex, targetsLength + totalWhiteLines, "#939393", true, relatedArticleId, sharedKeywordId);
                        if (line1) {
                            allLines.push(line1);
                            whiteLineIndex++;
                        }
...
_s1(ConnectionController, "J4P2fcGWSMwCzFhfYBNLNJGynes=", false, function() {
    return [
...
_s(TopBar, "WqLOomFyCfs3lVoj5akHuEYBxmY=");
_c = TopBar;
var _c;
...
function RotatingImage(param) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$f8cd670d$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__D__as__useFrame$3e$__["useFrame"])({
        "RotatingImage.useFrame": function(state, delta) {
            ...
            if (faceCamera) {
                ...
                var direction = tempVec2.current.subVectors(camera.position, currentPos).normalize();
                var forward = tempVec3.current.set(0, 0, 1);
                ...
                var right = tempVec3.current.crossVectors(worldUp.current, directionToCenter);
                if (right.length() < 0.001) {
                    right.set(1, 0, 0);
                }
                right.normalize();
                var stableUp = tempVec4.current.crossVectors(directionToCenter, right).normalize();
                var basis = tempMatrix.current.makeBasis(right, stableUp, directionToCenter);
                targetQuaternion.setFromRotationMatrix(basis);
                if (tiltAmount !== 0) {
                    var tiltQuaternion = tempQuat2.current.setFromAxisAngle(right, tiltAmount);
            ...
            var forward1 = tempVec2.current.set(0, 0, 1);
            forward1.applyQuaternion(currentQuaternion);
            var toCamera = tempVec3.current.subVectors(camera1.position, cardPosition).normalize();
            var dotProduct = forward1.dot(toCamera);
    ...
    var crossZPosition = 0.01;
    var circleRadius = crossSize * 0.7;
    var titleZPosition = 0.01;
    var readButtonZPosition = 0.01;
    var titleWidthPx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RotatingImage.useMemo[titleWidthPx]": function() {
            return scale[0] * 20 * 2.25 * 0.9;
        }
    }["RotatingImage.useMemo[titleWidthPx]"], [
        scale
    ]);
    var titleHeightUnits = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RotatingImage.useMemo[titleHeightUnits]": function() {
            return 2.6;
        }
    }["RotatingImage.useMemo[titleHeightUnits]"], []);
    var readButtonYPosition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RotatingImage.useMemo[readButtonYPosition]": function() {
            if (showTitle) {
                var titleBottom = scale[1] / 2 - titleHeightUnits / 2;
                var imageBottom = -scale[1] / 2;
                return (titleBottom + imageBottom) / 2;
            }
            return 0; // Center if no title
        }
    }["RotatingImage.useMemo[readButtonYPosition]"], [
        scale,
        showTitle,
        titleHeightUnits
    ]);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("group", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("group", {
            ...
            children: [
                ...
                showTitle && title && htmlElementsVisible && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("group", {
                    position: [
                        0,
                        scale[1] / 2,
                        titleZPosition
                ...
                showReadButton && htmlElementsVisible && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("group", {
                    position: [
                        0,
                        readButtonYPosition,
                        readButtonZPosition
                ...
                showCross && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("group", {
                    position: [
                        0,
                        crossBottomPosition,
                        crossZPosition
...
_s(RotatingImage, "rhgGStofsPdp7jzWQvQCdpn1Xao=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$f8cd670d$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__D__as__useFrame$3e$__["useFrame"]
    ];
});
...
_s1(ArticleNodeContent, "ZzPEPrQBX1Cd/WWErPgOITYMTWU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"],
...
function GlossaryNodeContent(param) {
    ...
    var _useStore2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])('selectedNodeStore', null), 1), selectedNode = _useStore2[0];
    ...
    var _useStore3 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])("".concat(nodeData.id, "Store"), false), 2), clickCounter4 = _useStore3[0], setClickCounter4 = _useStore3[1];
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        (isSelected || isHighlighted || linesActive) && nodeData.hasOpenButton && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            ...
                                            onClick: function(e) {
                                                e.stopPropagation();
                                                window.location.href = "/glossary#".concat(nodeData.id);
                                            },
                                            children: "OPEN"
                                        }, void 0, false, {
                                            fileName: "[project]/components/templates/GlossaryNodeTemplate.jsx",
...
_s1(GlossaryNodeContent, "Dh9bgTyZeD7ZkWPBZgr0IsOUURY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$utils$2f$LoadingStateManager$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNodeVisibility"],
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$utils$2f$useConnectionHighlight$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useConnectionHighlight"],
...
"[project]/components/homePageComponents/titleBox.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var TitleBox = function() {
    ...
    var closeCloseUp = function closeCloseUp() {
    ...
    var keyWordClick = function keyWordClick() {
        setKeyWordOne(!keyWordOne);
        console.log(keyWordOne);
    };
    var keyWordClickTwo = function keyWordClickTwo() {
        setKeyWordTwo(!keyWordTwo);
    };
    var keyWordClickTree = function keyWordClickTree() {
        setKeyWordTree(!keyWordTree);
    };
    var keyWordClickFour = function keyWordClickFour() {
        setKeyWordTree(!keyWordFour);
    };
    var keyWordClickFive = function keyWordClickFive() {
        setKeyWordTree(!keyWordFive);
    };
    _s();
    var _useStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])("handleOpen"), 2), handleOpen = _useStore[0], setHandleOpen = _useStore[1];
    var _useStore1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])("closeCloseUpVar"), 2), closeCloseUpVar = _useStore1[0], setCloseCloseUpVar = _useStore1[1];
    var _useStore2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])("handleTitleBox"), 2), handleTitleBox = _useStore2[0], setHandelTitleBox = _useStore2[1];
    var _useStore3 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])("clicked"), 2), clicked = _useStore3[0], setClicked = _useStore3[1];
    var _useStore4 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])("handleClicks"), 2), handleClicks = _useStore4[0], setHandleClicks = _useStore4[1];
    var _useStore5 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])("keyWordOne"), 2), keyWordOne = _useStore5[0], setKeyWordOne = _useStore5[1];
    var _useStore6 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])("keyWordTwo"), 2), keyWordTwo = _useStore6[0], setKeyWordTwo = _useStore6[1];
    var _useStore7 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])("keyWordTree"), 2), keyWordTree = _useStore7[0], setKeyWordTree = _useStore7[1];
    var _useStore8 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])("keyWordFour"), 2), keyWordFour = _useStore8[0], setKeyWordFour = _useStore8[1];
    var _useStore9 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])("keyWordFive"), 2), keyWordFive = _useStore9[0], setKeyWordFive = _useStore9[1];
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "titlebox",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(TitleBox, "rvCMYOqcm8ypbeMEbElDNn5L888=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"],
...
var _c;
__turbopack_context__.k.register(_c, "TitleBox");
if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_type_of$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(globalThis.$RefreshHelpers$) === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$homePageComponents$2f$titleBox$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/homePageComponents/titleBox.jsx [app-client] (ecmascript)");
;
;
;
;
...
var HomePage = function() {
    ...
    var _useState1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false), 2), modalIsOpen = _useState1[0], setOpen = _useState1[1];
    ...
    var _useStore5 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])('handleTitleBox', false), 2), handleTitleBox = _useStore5[0], setHandleTitleBox = _useStore5[1];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HomePage.useEffect": function() {
            if (("TURBOPACK compile-time value", "object") !== 'undefined' && document.getElementById('root')) {
                try {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            handleTitleBox && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$homePageComponents$2f$titleBox$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                fileName: "[project]/app/living-continuity/page.js",
                lineNumber: 351,
                columnNumber: 26
            }, _this),
...
_s(HomePage, "5i7HHDWY16f7s4nBn/DYskCAKmM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$usestore$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"],
...
//# sourceMappingURL=_48944373._.js.map