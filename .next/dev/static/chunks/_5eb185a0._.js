...
function RotatingImage(param) {
    ...
    var readButtonYPosition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RotatingImage.useMemo[readButtonYPosition]": function() {
            if (showTitle) {
                var topOfArticle = scale[1] / 2;
                var bottomOfArticle = -scale[1] / 2;
                var titlePosition = topOfArticle;
                var pixelsPerUnit = 20 * 2.25 * 0.9;
                var unitsPerPixel = 1 / pixelsPerUnit;
                var titleFontSizePx = 30;
                var titleLineHeightPx = titleFontSizePx * 1.35;
                var titlePaddingTopPx = 18 * 1.2;
                var titlePaddingBottomPx = 18 * 2;
                var estimatedTitleContentHeightPx = titleLineHeightPx * 2;
                var titleTotalHeightPx = titlePaddingTopPx + estimatedTitleContentHeightPx + titlePaddingBottomPx;
                var titleTotalHeight = titleTotalHeightPx * unitsPerPixel;
                var titleBottom = titlePosition - titleTotalHeight / 2;
                var availableSpace = titleBottom - bottomOfArticle;
...
_s(RotatingImage, "buHpvZJYrMgBWmXcUixa9R/1QYs=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$f8cd670d$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__D__as__useFrame$3e$__["useFrame"]
    ];
});
...
//# sourceMappingURL=_5eb185a0._.js.map