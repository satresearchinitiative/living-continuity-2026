 ...
 */ function createGradient(color, direction) {
    ...
    if (direction === 'top') {
        ...
        return "linear-gradient(to bottom, ".concat(transparent, " 0%, ").concat(color, " 50%, ").concat(transparent, " 100%)");
    } else {
        return "linear-gradient(to top, ".concat(color, " 0%, ").concat(transparent, " 100%)");
    }
}
...
_s(NavigationControls, "TEFc7WjaqgkBjH+h+T2GtqaJgg8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
...
//# sourceMappingURL=_94f86f5c._.js.map