...
"[project]/node_modules/three.meshline/src/THREE.MeshLine.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
(function() {
    'use strict';
    var root = this;
    var has_require = ("TURBOPACK compile-time value", "function") !== 'undefined';
    var THREE = root.THREE || has_require && __turbopack_context__.r("[project]/node_modules/three/build/three.cjs [app-client] (ecmascript)");
    if (!THREE) throw new Error('MeshLine requires three.js');
    var MeshLine = /*#__PURE__*/ function(_THREE_BufferGeometry) {
        _inherits._(MeshLine, _THREE_BufferGeometry);
        function MeshLine() {
            _class_call_check._(this, MeshLine);
            var _this;
            _this = _call_super._(this, MeshLine);
    ...
    MeshLine.prototype.setPoints = function(points, wcb) {
        if (!_instanceof._(points, Float32Array) && !_instanceof._(points, Array)) {
        ...
        this.positions = [];
        this.counters = [];
        if (points.length && _instanceof._(points[0], THREE.Vector3)) {
    ...
    function MeshLineRaycast(raycaster, intersects) {
        ...
        var step = _instanceof._(this, THREE.LineSegments) ? 2 : 1;
   ...
   */ MeshLine.prototype.advance = function(position) {
    ...
    var MeshLineMaterial = /*#__PURE__*/ function(_THREE_ShaderMaterial) {
        _inherits._(MeshLineMaterial, _THREE_ShaderMaterial);
        function MeshLineMaterial(parameters) {
            _class_call_check._(this, MeshLineMaterial);
            var _this;
            _this = _call_super._(this, MeshLineMaterial, [
                {
...
//# sourceMappingURL=node_modules_1d969fcc._.js.map